...
"[project]/Documents/AMG-mODEL/my-app/hooks/usePortfolioData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$contentful$2f$dist$2f$esm$2f$contentful$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])({
...
const usePortfolioData = (activeTab)=>{
    _s();
    const [models, setModels] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "usePortfolioData.useEffect": ()=>{
            const fetchModels = {
                "usePortfolioData.useEffect.fetchModels": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const resolvedModels = response.items.map({
                            "usePortfolioData.useEffect.fetchModels.resolvedModels": (item)=>({
                                    ...item,
                                    fields: {
                                        ...item.fields,
                                        images: item.fields[contentTypes[activeTab].field]?.map({
                                            "usePortfolioData.useEffect.fetchModels.resolvedModels": (link)=>response.includes?.Asset?.find({
                                                    "usePortfolioData.useEffect.fetchModels.resolvedModels": (asset)=>asset.sys.id === link.sys.id
                                                }["usePortfolioData.useEffect.fetchModels.resolvedModels"])
                                        }["usePortfolioData.useEffect.fetchModels.resolvedModels"]).filter(Boolean) || []
                                    }
                                })
                        }["usePortfolioData.useEffect.fetchModels.resolvedModels"]);
            ...
            }["usePortfolioData.useEffect.fetchModels"];
            fetchModels();
        }
    }["usePortfolioData.useEffect"], [
        activeTab
...
_s(usePortfolioData, "sYyI0iYPtxHvtYH/7Uqk0wq7Luc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/AMG-mODEL/my-app/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/AMG-mODEL/my-app/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$hooks$2f$usePortfolioData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/AMG-mODEL/my-app/hooks/usePortfolioData.ts [app-client] (ecmascript)"); // Adjust path as needed
...
function PortfolioGrid() {
    ...
    ;
    const { allImages, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$hooks$2f$usePortfolioData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePortfolioData"])(activeTab);
    if (loading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(PortfolioGrid, "2I/zzuexxsYthiKaQ+eCRxCsTwU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$hooks$2f$usePortfolioData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePortfolioData"]
    ];
});
_c = PortfolioGrid;
var _c;
...
//# sourceMappingURL=Documents_AMG-mODEL_my-app_26d1d034._.js.map