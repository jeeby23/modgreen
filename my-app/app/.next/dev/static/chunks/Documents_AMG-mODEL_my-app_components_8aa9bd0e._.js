...
function PortfolioGrid() {
    _s();
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('MODEL') // Starts with 'MODEL'
    ;
    const [viewMode, setViewMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$AMG$2d$mODEL$2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('grid');
            ...
            async function fetchModels() {
                try {
                    ...
                    const resolvedModels = response.items.map({
                        "PortfolioGrid.useEffect.fetchModels.resolvedModels": (item)=>({
                                ...item,
                                fields: {
                                    ...item.fields,
                                    images: item.fields[contentTypes[activeTab].field]?.map({
                                        "PortfolioGrid.useEffect.fetchModels.resolvedModels": (link)=>response.includes?.Asset?.find({
                                                "PortfolioGrid.useEffect.fetchModels.resolvedModels": (asset)=>asset.sys.id === link.sys.id
                                            }["PortfolioGrid.useEffect.fetchModels.resolvedModels"])
                                    }["PortfolioGrid.useEffect.fetchModels.resolvedModels"]).filter(Boolean) || []
                                }
                            })
                    }["PortfolioGrid.useEffect.fetchModels.resolvedModels"]);
...
_s(PortfolioGrid, "svfevj3bxGjV1YHWRHcVPeBV8K8=");
_c = PortfolioGrid;
var _c;
...
//# sourceMappingURL=Documents_AMG-mODEL_my-app_components_8aa9bd0e._.js.map